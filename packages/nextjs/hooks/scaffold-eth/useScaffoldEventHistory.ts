...
>({
  ...
  const fromBlockValue =
    fromBlock !== undefined
      ? fromBlock
      : BigInt(
        deployedContractData && "deployedOnBlock" in deployedContractData && (typeof deployedContractData.deployedOnBlock === "number" || typeof deployedContractData.deployedOnBlock === "string")
